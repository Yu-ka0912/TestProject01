...
・AnyEdit、Eclipse、m2e、PDT、PyDev の差分訳追加

1.6.5 - 2016.02.28

・Tomcat Launcher、PyDev、CDT、Eclipse の差分訳追加

1.6.4 - 2016.02.03

・Javassist 3.20.0-GA が Java 6 で動作しないため最新版に差し替え (本家バージョンが更新されずに差し替えられている)
・Eclips 4.5、CheckStyle の差分訳追加

1.6.3 - 2015.11.01

・[#35674] Javassist を 3.20.0-GA に更新
・Any Edit Tools、WTP の差分訳追加

1.6.2 - 2015.10.02

・Eclipse リファクタリングに関する翻訳を修正

1.6.2 - 2015.09.27

・Buidship、Eclipse、WTP の差分訳追加
・MARS スプラッシュ画像変更

1.6.1 - 2015.08.18

・Buildship、Wildfly サーバー・アダプターの差分訳追加
